...
export function dataExtensions(prototype){
    prototype.addData = function(name, initials, collectionDate, value) { 
        this.Data = new Data(name, initials, collectionDate, value)
        this.Data_Name = this.Data.Name;
        this.Data_CollectionDate = this.Data.CollectionDate;
    }
    prototype.addData = function(data) { 
        this.Data = data
        this.Data_Name = this.Data.Name;
        this.Data_CollectionDate = this.Data.CollectionDate;
    }
...
export class DataDecimal extends Data {
    constructor(collectionDate, value) {
        super(collectionDate, value);
